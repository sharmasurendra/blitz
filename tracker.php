        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="shop-header-title">
                    ...
                    <div class="shop-menu">
                        <ul>
                            <li><a <?php if(isset($getId) && $getId == 1)  echo 'class="active"';?>href="?categoryId=1">OffBeat Jewels</a></li>
                            <li><a <?php if(isset($getId) && $getId == 2)  echo 'class="active"';?>href="?categoryId=2">Progresswithus</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="s-product-img">
                                                        ...
                                                        <div class="global-row">
                                                            <div class="global-cell">
                                                                <div class="hover-view-content">
                                                                    <a href="shop-category.php#" class="modal-view detail-link quickview" data-toggle="modal" data-target="#productModal' . $productId . '">Quick View</a>
                                                                    <div class="ratings">
                                                                        <ul>
                                                                            <li>
                                                                                <div class="star">
                                                ...
                                                <div class="pro-action">
                                                    <div class="product-cart-area-list">
                                                        ...
                                                        <div class="cart-btn right link-compare"><a href="shop-category.php#" data-toggle="tooltip" data-placement="top" title="Add To Wishlist" ><i class="fa fa-heart-o"></i>
                                                        </a></div>
